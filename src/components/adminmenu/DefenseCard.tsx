  ...
  const handleEditCounter = async (e: React.MouseEvent, counter: Counter) => {
    ...
    try {
      if (onEditCounter) {
        ...
        console.log(
          "DefenseCard: Sending complete counter data:",
          completeCounter
        );
          ...
          <div className="absolute top-4 right-4 flex gap-2 z-50 bg-black/50 p-1 rounded-lg">
            ...
            <button
              onClick={(e) => {
                ...
                if (
                  window.confirm(
                    "Are you sure you want to delete this defense?"
                  )
                ) {
                  onDelete(defense);
                }
                ...
                >
                  <div className="flex justify-between items-start">
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {counter.counterType.charAt(0).toUpperCase() +
                          counter.counterType.slice(1)}
                      </span>
                      {counter.video_url && (
                        <VideoIndicator videoUrl={counter.video_url} />
                      )}
                    </div>
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    ...
                    "leader" in counter.counterSquad ? (
                      ...
                      <>
                        ...
                        {/* Starting Lineup Section - Explicit display of all ships */}
                        <div className="w-full">
                          <div className="text-xs text-white/60 mb-1">
                            Starting Lineup (
                            {counter.counterSquad.startingLineup.length})
                          </div>
                              ...
                              (ship, index) => (
                                <div key={ship.id} className="relative">
                                  <UnitImage
                                    ...
                                    size="md"
                                  />
                                  <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 text-[10px] bg-black/90 px-1 rounded">
                                    Ship {index + 1}
                                  </div>
                                </div>
                              )
                        ...
                        {/* Reinforcements Section - Explicit display of all ships */}
                        <div className="w-full">
                          <div className="text-xs text-white/60 mb-1">
                            Reinforcements (
                            {counter.counterSquad.reinforcements.length})
                          </div>
                          <div className="flex flex-wrap gap-2">
